...
/**
 * Servlet implementation class MachineMorePageServlet
 */
@WebServlet("/machine/morePage")
public class MachineMorePageServlet extends HttpServlet {
...
//		System.out.println("coffeeList= " + coffeeList);
		...
		new Gson().toJson(machineList, response.getWriter());
	}
